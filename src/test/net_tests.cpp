...
BOOST_AUTO_TEST_CASE(caddrdb_read)
{
    ...
    addrmanUncorrupted.Add(CAddress(addr1), CService("252.5.1.1", 44144));
    addrmanUncorrupted.Add(CAddress(addr2), CService("252.5.1.1", 44144));
    addrmanUncorrupted.Add(CAddress(addr3), CService("252.5.1.1", 44144));
