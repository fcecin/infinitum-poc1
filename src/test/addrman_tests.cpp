...
BOOST_AUTO_TEST_CASE(addrman_select)
{
    ...
    addrman.Add(CAddress(addr2), CService("250.3.1.1", 44144));
    addrman.Add(CAddress(addr3), CService("250.3.1.1", 44144));
    addrman.Add(CAddress(addr4), CService("250.4.1.1", 44144));
    ...
    addrman.Add(CAddress(addr5), CService("250.3.1.1", 44144));
    addrman.Good(CAddress(addr5));
    addrman.Add(CAddress(addr6), CService("250.3.1.1", 44144));
    addrman.Good(CAddress(addr6));
    addrman.Add(CAddress(addr7), CService("250.1.1.3", 44144));
...
BOOST_AUTO_TEST_CASE(addrman_find)
{
    ...
    CAddress addr1 = CAddress(CService("250.1.2.1", 44144));
    CAddress addr2 = CAddress(CService("250.1.2.1", 9999));
    CAddress addr3 = CAddress(CService("251.255.2.1", 44144));
...
BOOST_AUTO_TEST_CASE(addrman_getaddr)
{
    ...
    CAddress addr1 = CAddress(CService("250.250.2.1", 44144));
    addr1.nTime = GetAdjustedTime(); // Set time so isTerrible = false
    CAddress addr2 = CAddress(CService("250.251.2.2", 9999));
    addr2.nTime = GetAdjustedTime();
    CAddress addr3 = CAddress(CService("251.252.2.3", 44144));
    addr3.nTime = GetAdjustedTime();
    CAddress addr4 = CAddress(CService("252.253.3.4", 44144));
    addr4.nTime = GetAdjustedTime();
    CAddress addr5 = CAddress(CService("252.254.4.5", 44144));
...
BOOST_AUTO_TEST_CASE(caddrinfo_get_tried_bucket)
{
    ...
    CAddress addr1 = CAddress(CService("250.1.1.1", 44144));
